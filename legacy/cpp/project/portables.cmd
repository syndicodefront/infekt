...
set MSVCRedist64=C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Redist\MSVC\14.36.32532\x64
set MSVCRedist32=C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Redist\MSVC\14.36.32532\x86
...
xcopy /Y "%MSVCRedist32%\Microsoft.VC143.OpenMP\*.dll" %PP32%
xcopy /Y "%MSVCRedist64%\Microsoft.VC143.OpenMP\*.dll" %PP64%
...
xcopy /Y "%MSVCRedist32%\Microsoft.VC143.CRT\msvc*.dll" %PAP%\App\iNFekt
xcopy /Y "%MSVCRedist32%\Microsoft.VC143.CRT\concrt*.dll" %PAP%\App\iNFekt
xcopy /Y "%MSVCRedist32%\Microsoft.VC143.CRT\vcruntime*.dll" %PAP%\App\iNFekt
xcopy /Y "%MSVCRedist32%\Microsoft.VC143.OpenMP\*.dll" %PAP%\App\iNFekt
xcopy /Y "%MSVCRedist32%\Microsoft.VC143.CXXAMP\*.dll" %PAP%\App\iNFekt
