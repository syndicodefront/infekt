...
/*
    ...
    This is similar to the box filter sample in the SDK, but it uses the previou
    ...
    The GPU processes columns of the image in parallel. To avoid uncoalesced read
